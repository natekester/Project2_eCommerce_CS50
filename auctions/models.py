...
class Auction(models.Model):
    ...
    largest_bid = models.FloatField(validators=[MinValueValidator(0.01), MaxValueValidator(500000)])
    ...
    auction_status = models.CharField(max_length=32)#for now it should either be 'open' or 'closed' - but maybe you'd want to add other- such as paused, or revoked, or in review
